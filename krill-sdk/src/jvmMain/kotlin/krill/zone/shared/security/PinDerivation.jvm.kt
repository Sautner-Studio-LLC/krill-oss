/**
 * JVM actual of [PinDerivation], backed by `javax.crypto.Mac` for HMAC-SHA256.
 *
 * Used by both the desktop Compose client and the Krill server itself (which
 * derives the expected token to validate incoming Bearer headers).
 */
